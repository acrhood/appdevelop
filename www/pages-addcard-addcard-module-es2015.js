...
/* harmony import */ var _addcard_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./addcard.page */ "./src/app/pages/addcard/addcard.page.ts");
...
/* harmony import */ var _addcard_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./addcard-routing.module */ "./src/app/pages/addcard/addcard-routing.module.ts");
/* harmony import */ var _addcard_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./addcard.page */ "./src/app/pages/addcard/addcard.page.ts");
...
AddcardPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _addcard_routing_module__WEBPACK_IMPORTED_MODULE_5__["AddcardPageRoutingModule"],
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
/* harmony import */ var _components_general_general_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../components/general/general.component */ "./src/app/components/general/general.component.ts");
...
/* harmony import */ var _modals_verifypass_verifypass_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../modals/verifypass/verifypass.page */ "./src/app/modals/verifypass/verifypass.page.ts");
...
let AddcardPage = class AddcardPage {
    constructor(afAuth, crudService, navCtrl, modalCtrl, general, fts, loadingController, storage) {
        this.afAuth = afAuth;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.type == undefined) {
                ...
                if (providerId == 'google.com' || providerId == 'facebook.com') {
                    ...
                    const numcard = this.numC.replace(' ', '').replace(' ', '').replace(' ', '');
                    this.pssC = (yield this.storage.getItem('passCache')).value;
                    console.log('pass');
                    this.pssC = this.pssC.substring(0, this.pssC.length - 1);
                    this.addingCard(loading, numcard, month, year);
                }
                else {
                    this.storage.getItem('passCache').then((suc) => {
                        console.log(suc);
    ...
    addingCard(loading, numcard, month, year) {
        this.crudService.crud({ sel: '', tbl: 96, where: impresa }).subscribe(sucft => {
            this.fts.userIncludeCard(sucft[0][0][0], this.username, this.pssC + '$', this.titC, numcard, month, year, this.cvv).subscribe((succ) => {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('typecard', { read: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], static: false }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])
], AddcardPage.prototype, "typecard", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('psscard', { read: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], static: false }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])
], AddcardPage.prototype, "psscard", void 0);
AddcardPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-addcard',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./addcard.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/addcard/addcard.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./addcard.page.scss */ "./src/app/pages/addcard/addcard.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"],
        _services_crud_service__WEBPACK_IMPORTED_MODULE_3__["CrudService"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"],
        _components_general_general_component__WEBPACK_IMPORTED_MODULE_5__["GeneralComponent"],
...
//# sourceMappingURL=pages-addcard-addcard-module-es2015.js.map