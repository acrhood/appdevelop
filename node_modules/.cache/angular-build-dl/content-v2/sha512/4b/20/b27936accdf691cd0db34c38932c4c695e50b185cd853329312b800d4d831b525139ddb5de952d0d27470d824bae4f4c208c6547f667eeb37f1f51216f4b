...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-user-user-module"], {
  ...
  function srcAppPagesUserUserPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UserPage = /*#__PURE__*/function () {
      function UserPage(crudService, navCtrl, platform, authService) {
        var _this = this;
        ...
        firebase__WEBPACK_IMPORTED_MODULE_5__["auth"]().onAuthStateChanged(function (user) {
          if (user) {
            ...
            _this.crudService.crud(data).subscribe(function (res) {
              console.log(res);
              _this.nameusr = res[0][0][1];
              _this.tipoUser = res[0][0][2];
              _this.mailusr = res[0][0][3];
              var reportes = document.getElementById('reports');
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    this.authService.signOut().then(function (res) {
                      ...
                      _this2.navCtrl.navigateBack('/signin');
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_crud_service__WEBPACK_IMPORTED_MODULE_4__["CrudService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]])], UserPage);
    /***/
  }
}]);
